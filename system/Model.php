<?php class Model {
  ...
  static function filterParams ($params) {
    $permited = array_flip(static::$permitted);
  ...
  static function buildUpdateQuery ($filterParams) {
    ...
    return "UPDATE $table SET $keys WHERE id = ?;";
  }
  ...
  static private function instance () {
    ...
    if (self::$instance == null) {
      self::$instance = new mysqli(HOST_NAME, USER_NAME, PASS_WORD, DATA_BASE);

      self::$instance->set_charset(CHAR_SET);
